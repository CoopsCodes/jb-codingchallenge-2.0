...
class App extends Component {
  ...
  handleSubmit(e) {
    ...
    //     this.state.lockOutTime1 > this.state.timeNow1)
    // ) {
    //   this.callApi();
    //   this.setState(state => ({
    //     callsMade1: state.callsMade1 + 1
    ...
    // } else {
    //   alert(
    //     `You've used all the key allocations on this selection right now please try again after ${this.state.lockOutTime1}`
    //   );
    // }

    // if (
    //   (this.state.key === "KEY2" && this.state.callsMade2 <= 4) ||
    //   (this.state.key === "KEY2" &&
    //     this.state.callsMade2 <= 4 &&
    //     this.state.lockOutTime2 > this.state.timeNow2)
    // ) {
    //   this.setState(state => ({
    ...
    // } else {
    //   alert(
    //     `You've used all the key allocations on this selection right now please try again after ${this.state.lockOutTime2}`
    //   );
    // }
